...
export function RateCard({
  ...
  return (
    ...
    >
      <Card className='flex flex-col sm:flex-row items-center p-4 transition-all duration-200 group-hover:shadow-xl group-hover:border-primary/50 overflow-hidden hover:border-titlecolor hover:bg-red-200'>
        ...
        <div className='flex-grow text-center sm:text-left'>
          <h3 className='text-xl font-semibold text-titlecolor'>{title}</h3>
        ...
        <div className='flex items-center mt-4 sm:mt-0 sm:ml-6 flex-shrink-0'>
          <Badge
            variant='secondary'
            className='text-xl font-semibold py-2 px-4 bg-blue-700 text-white'
          >
            {price}€
          </Badge>
